...
from textwrap import dedent  # for better text formatting as it removes leading whitespace
class Scene(object):
    def enter(self):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                Your laser hits his costume but misses him entirely. This completely ruins his brand new costume his
                mother bought him, which makes him fly into an insane rage and blast you repeatedly in the face until you are dead.
                Then he eats you.
            """))
            return 'death'
            ...
            print(dedent("""
                ...
                as the Gothon's blaster cranks a laser past your head. In the middle of your
                foot slips and you bang your head on the metal wall and pass out.
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print(dedent("""
                ...
                You decide to sit there, and finally The Gothons blow up the ship from their 
                ship and you die.
            """))
            return 'death'
...
class EscapePod(Scene):
    def enter(self):
        print(dedent("""
            ...
            You get to the escape pod, open the door, and find that there are 5 pods.
            Some of them are damaged but you don't have time to look.
        ...
        if int(guess) != good_pod:
            print(dedent("""
                ...
                The pod escapes out into the void of space, then implodes as the hull ruptures,
